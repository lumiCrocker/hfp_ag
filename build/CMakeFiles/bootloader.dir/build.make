...
CMakeFiles/bootloader-complete: bootloader-prefix/src/bootloader-stamp/bootloader-install
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'bootloader'"
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/CMakeFiles
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/CMakeFiles/bootloader-complete
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-done

bootloader-prefix/src/bootloader-stamp/bootloader-install: bootloader-prefix/src/bootloader-stamp/bootloader-build
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No install step for 'bootloader'"
	cd /home/parker/esp/hfp_ag/build/bootloader && /usr/bin/cmake -E echo_append
	cd /home/parker/esp/hfp_ag/build/bootloader && /usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-install

bootloader-prefix/src/bootloader-stamp/bootloader-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Creating directories for 'bootloader'"
	/usr/bin/cmake -E make_directory /home/parker/esp/esp-idf/components/bootloader/subproject
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader-prefix
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader-prefix/tmp
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader-prefix/src
	/usr/bin/cmake -E make_directory /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-mkdir

bootloader-prefix/src/bootloader-stamp/bootloader-download: bootloader-prefix/src/bootloader-stamp/bootloader-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-download

bootloader-prefix/src/bootloader-stamp/bootloader-update: bootloader-prefix/src/bootloader-stamp/bootloader-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No update step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-update

bootloader-prefix/src/bootloader-stamp/bootloader-patch: bootloader-prefix/src/bootloader-stamp/bootloader-download
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "No patch step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/parker/esp/hfp_ag/build/bootloader-prefix/src/bootloader-stamp/bootloader-patch
...
bootloader-prefix/src/bootloader-stamp/bootloader-build: bootloader-prefix/src/bootloader-stamp/bootloader-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/parker/esp/hfp_ag/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "Performing build step for 'bootloader'"
	cd /home/parker/esp/hfp_ag/build/bootloader && $(MAKE)
...
CMakeFiles/bootloader.dir/depend:
	cd /home/parker/esp/hfp_ag/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/parker/esp/hfp_ag /home/parker/esp/hfp_ag /home/parker/esp/hfp_ag/build /home/parker/esp/hfp_ag/build /home/parker/esp/hfp_ag/build/CMakeFiles/bootloader.dir/DependInfo.cmake --color=$(COLOR)
